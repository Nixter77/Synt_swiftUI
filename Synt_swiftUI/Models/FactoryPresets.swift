...
extension SynthPreset {
    ...
    private static let bassPresets: [SynthPreset] = [
        ...
        SynthPreset(
            ...
            attack: 0.02, decay: 0.25, sustain: 0.8, release: 0.25,
    ...
    private static let leadPresets: [SynthPreset] = [
        SynthPreset(
            ...
            attack: 0.02, decay: 0.18, sustain: 0.7, release: 0.22,
        ...
        SynthPreset(
            ...
            attack: 0.005, decay: 0.25, sustain: 0.55, release: 0.3,
        ...
        SynthPreset(
            ...
            attack: 0.03, decay: 0.2, sustain: 0.75, release: 0.28,
    ...
    private static let padPresets: [SynthPreset] = [
        SynthPreset(
            ...
            attack: 0.9, decay: 0.6, sustain: 0.85, release: 1.4,
        ...
        SynthPreset(
            ...
            attack: 1.0, decay: 0.7, sustain: 0.75, release: 1.5,
            filterCutoff: 900, filterResonance: 0.35,
        ...
        SynthPreset(
            ...
            attack: 1.5, decay: 1.0, sustain: 0.9, release: 2.2,
    ...
    private static let keysPresets: [SynthPreset] = [
        ...
        SynthPreset(
            ...
            attack: 0.02, decay: 0.1, sustain: 0.9, release: 0.15,
        ...
        SynthPreset(
            ...
            attack: 0.001, decay: 0.18, sustain: 0.2, release: 0.12,
        ...
        SynthPreset(
            ...
            attack: 0.008, decay: 0.65, sustain: 0.4, release: 0.5,
    ...
    private static let stringsPresets: [SynthPreset] = [
        ...
        SynthPreset(
            ...
            attack: 0.4, decay: 0.35, sustain: 0.85, release: 0.8,
        ...
        SynthPreset(
            ...
            attack: 0.15, decay: 0.25, sustain: 0.8, release: 0.45,
            filterCutoff: 2400, filterResonance: 0.22,
    ...
    private static let fxPresets: [SynthPreset] = [
        ...
        SynthPreset(
            ...
            attack: 0.001, decay: 0.08, sustain: 0.2, release: 0.08,
