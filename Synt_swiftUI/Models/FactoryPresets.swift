...
extension SynthPreset {
    ...
    private static let padPresets: [SynthPreset] = [
        SynthPreset(
            ...
            reverbMix: 0.32, reverbRoomSize: 0.62,
        ...
        SynthPreset(
            ...
            reverbMix: 0.34, reverbRoomSize: 0.65,
            delayTime: 0.4, delayFeedback: 0.22, delayMix: 0.08,
            masterVolume: 0.46,
        ...
        SynthPreset(
            ...
            reverbMix: 0.32, reverbRoomSize: 0.62,
            delayTime: 0.45, delayFeedback: 0.22, delayMix: 0.08,
            masterVolume: 0.44
        ),
    ]
    ...
    private static let fxPresets: [SynthPreset] = [
        SynthPreset(
            ...
            reverbMix: 0.34, reverbRoomSize: 0.65,
            delayTime: 0.35, delayFeedback: 0.25, delayMix: 0.1,
            masterVolume: 0.44,
        ...
        SynthPreset(
            ...
            reverbMix: 0.15,
            delayTime: 0.12, delayFeedback: 0.28, delayMix: 0.12,
            masterVolume: 0.50,
        ...
        SynthPreset(
            ...
            reverbMix: 0.32, reverbRoomSize: 0.65,
            masterVolume: 0.46,
